...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form id="myform" action="{{ route('employee.update', [$employee->id]) }}" method="POST"
                ...
                <fieldset class="mb-3">
                            ...
                            <div class="card">
                                <div class="card-img-actions m-1">
                                    <img id="previewImg" class="card-img img-fluid "
                                        ...
                                        src="{{ asset('global_assets/uploads/' . $employee->photo) }}" alt="">
                                    <div class="card-img-actions-overlay card-img">
                                        <a href="{{ asset('global_assets/uploads/' . $employee->photo) }}"
                        ...
                        <div class="col-sm-6 col-lg-8">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" id="name" name="name" maxlength="100"
                                    class="form-control maxlength-options" value="{{ $employee->name }}" required>
                            </div>

                            <div class="form-group row">
                                <label for="email">Email</label>
                                <input type="email" id="email" name="email" maxlength="150"
                                    class="form-control maxlength-options" value="{{ $employee->email }}" required>
                            </div>

                            <div class="form-group row">
                                <label for="phone">Phone</label>
                                <input type="text" id="phone" name="phone" maxlength="30"
                                    class="form-control maxlength-options" value="{{ $employee->phone }}" required>
                            </div>

                            <div class="form-group row">
                                <label for="address">Address</label>
                                <input type="text" id="address" name="address" maxlength="255"
                                    class="form-control maxlength-options" value="{{ $employee->address }}" required>
                            </div>

                            <div class="form-group row">
                                <label for="experience">Experience</label>
                                <input type="text" id="experience" name="experience" maxlength="50"
                                    class="form-control maxlength-options" value="{{ $employee->experience }}" required>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" id="salary" name="salary" maxlength="50"
                            class="form-control maxlength-options" value="{{ $employee->salary }}" required>
                    </div>

                    <div class="form-group row">
                        <label for="vacation">Vacation</label>
                        <input type="text" id="vacation" name="vacation" maxlength="50"
                            class="form-control maxlength-options" value="{{ $employee->vacation }}" required>
                    </div>

                    <div class="form-group row">
                        <label for="city">City</label>
                        <input type="text" id="city" name="city" maxlength="100"
                            class="form-control maxlength-options" value="{{ $employee->city }}" required>
                    </div>
                </fieldset>
