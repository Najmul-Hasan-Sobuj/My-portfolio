                        ...
                        <div class="col-sm-6 col-lg-8">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea rows="3" cols="3" maxlength="225" name="clients_statement"
                                    class="form-control maxlength-textarea" placeholder="This textarea has a limit of 225 chars." required></textarea>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="number" name="number" maxlength="5"
                                            class="form-control maxlength-options" placeholder="Enter number" required>
                                    </div>
                                </div>
