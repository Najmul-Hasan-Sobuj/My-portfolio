...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form id="myform" action="{{ route('provider.testimonial.update', [$testimonial->id]) }}" method="POST"
                            ...
                            <div class="card">
                                <div class="card-img-actions m-1">
                                    <img id="previewImg" class="card-img img-fluid "
                                        ...
                                        src="{{ asset('global_assets/uploads/' . $testimonial->image) }}" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-8">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" maxlength="100"
                                    class="form-control maxlength-options" value="{{ $testimonial->name }}"
                            ...
                            <div class="form-group">
                                ...
                                <select id="country" name="country" class="form-control select-search" data-fouc>
                                    <optgroup label="Mountain Time Zone">
                                        <option value="{{ $testimonial->country }}">{{ $testimonial->country }}</option>
                            ...
                            <div class="mb-3">
                                <label for="clients_statement">Clients Statement</label>
                                <textarea rows="3" cols="3" maxlength="225" name="clients_statement"
                                    class="form-control maxlength-textarea" placeholder="This textarea has a limit of 225 chars." required>{{ $testimonial->clients_statement }}</textarea>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select id="icon" name="icon" class="form-control select" data-fouc>
                                            <option value="{{ $testimonial->icon }}">{{ $testimonial->icon }}</option>
                                            ...
                                            <option value="far fa-trophy">far fa-trophy</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="number" name="number" maxlength="5"
                                            class="form-control maxlength-options" value="{{ $testimonial->number }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="custom-file">
                                            <input type="file" id="image" name="image"
                                                class="custom-file-input" onchange="previewFile(this);">
